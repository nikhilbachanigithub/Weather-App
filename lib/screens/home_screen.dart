...
class HomeScreen extends StatefulWidget {
  ...
  final VoidCallback onThemeToggle; // Add this line

  const HomeScreen({
    Key? key,
    required this.isDarkMode, // Add this line
    required this.onThemeToggle, // Add this line
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(widget.isDarkMode ? Icons.brightness_high : Icons.brightness_2),
